...
function events() {
  $(".section-alert button").click(function () {
    getNotifications(function (response) {
      ...
      const alert_notification = notifications.find(
  ...
  $(".section-popup button.button-popup").click(function () {
    getNotifications(function (response) {
      const notifications = response.notifications;
      const popup_notification = notifications.find(
  ...
  $(".section-email button.button-email").click(function (e) {
    e.preventDefault();
    getNotifications(function (response) {
      const notifications = response.notifications;
      const email_notification = notifications.find(
      ...
      new Notification({
        ...
        button_text: email_notification.button_text,
      }).show();
    });
  });
}
...
function Email() {
  ...
  function events() {
    ...
    $(".email")
      .unbind("click")
      .click("click", function (e) {
        const is_wrapper = e.target.classList.contains("email");
